...
- **Minimum supported Node.js raised to 22** (was 20), matching the host runtime. `engines.node`, CI, and docs updated to match; `.nvmrc` and `setup/install-node.sh` already installed 22.

...
for c in 'smoke-pr-gate.sh:5325' 'smoke-campaign-controller.py:1346-1348' \
         'smoke-run-scaffold.sh:267-269' 'smoke-campaign-controller.py:1335-1345'; do
...
cite smoke-campaign-controller.py 1291 'def _owner_wake'
cite smoke-campaign-controller.py 1341 'os.unlink("brief-{}.ack"'
cite smoke-campaign-controller.py 1346 'if c.get("wake"):'

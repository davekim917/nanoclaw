...
This project is indexed by GitNexus as **nanoclaw** (1247 symbols, 3361 relationships, 98 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

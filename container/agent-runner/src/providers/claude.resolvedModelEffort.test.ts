...
describe('family-default effort follows the RESOLVED model, not the opus alias', () => {
  ...
  it('test_opus_default_group_gets_opus_family_default', () => {
    // Opus's family default moved high → medium on 2026-09-15, when Opus
    // became the model an UNPINNED group runs: this default is now what the
    // fleet burns by default, not what a deliberate escalation burns.

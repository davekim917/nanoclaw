...
This project is indexed by GitNexus as **nanoclaw** (1292 symbols, 3497 relationships, 102 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

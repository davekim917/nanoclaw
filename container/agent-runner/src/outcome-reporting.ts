...
export const OUTCOME_REPLY_NUDGE =
  ...
  'Use send_message with purpose="reply" to answer the person, or purpose="outcome" with the original work-item ' +
  'and evidence only if that work item is finished. Required approval tools remain available. ' +

...
Read `docs/review-notes.md` before writing or reviewing code (in a container: `/workspace/project/docs/review-notes.md`). A finding in a class already there is a repeat, and its line names the check that should have caught it.
...
It also tells the reviewer: read `docs/review-notes.md` before writing or
reviewing code (in a container: `/workspace/project/docs/review-notes.md`), and
check the diff against the classes already there.

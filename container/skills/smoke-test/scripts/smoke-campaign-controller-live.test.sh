...
for c in 'smoke-pr-gate.sh:5325' 'smoke-campaign-controller.py:1455-1457' \
         'smoke-run-scaffold.sh:267-269' 'smoke-campaign-controller.py:1444-1454'; do
...
cite smoke-campaign-controller.py 1400 'def _owner_wake'
cite smoke-campaign-controller.py 1450 'os.unlink("brief-{}.ack"'
cite smoke-campaign-controller.py 1455 'if c.get("wake"):'

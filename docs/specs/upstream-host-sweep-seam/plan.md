...
Executable acceptance criteria: **required** — behavior-preserving restructuring of the host's only periodic control path; every PR carries the named cases in §8 (81 total).

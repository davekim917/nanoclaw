  ...
  tool: {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        model: {
          type: ['string', 'null'],
          description: 'Model to pin (e.g. `opus48`, `claude-sonnet-5`). Pass null to clear the per-channel override.',
        },
      },
      required: ['model'],
    },

...
adopt)
  ...
  # recovery included (smoke-pr-gate.sh:4800), and writes it to the lease
  # (:4829), the PR authority (:4834) and the state (:4872-4879) — no line of
  ...
  # smoke-pr-gate.sh:4874-4878) — so valid prior evidence keeps validating and recovery
  ...
  # same guard as smoke-pr-gate.sh:4851. Production wrappers never set it.

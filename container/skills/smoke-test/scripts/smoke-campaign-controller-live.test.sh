...
for c in 'smoke-pr-gate.sh:5325' 'smoke-campaign-controller.py:1419-1421' \
         'smoke-run-scaffold.sh:267-269' 'smoke-campaign-controller.py:1408-1418'; do
...
cite smoke-campaign-controller.py 1364 'def _owner_wake'
cite smoke-campaign-controller.py 1414 'os.unlink("brief-{}.ack"'
cite smoke-campaign-controller.py 1419 'if c.get("wake"):'

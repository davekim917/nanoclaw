...
# stalledAlertRunId (smoke-pr-gate.sh:4793, checked :4772) and the control-file
# wakes (:1463, :4868, :4918, :5255). The gate wrote the latch; the worker died
...
# controller with this process's environment (smoke-campaign-controller.py:1413

  ...
  it('physically excludes instructions and all private eval surfaces, then rejects any residual claim-id leak', () => {
    expect(
      filterEvaluationSourcePaths([
        ...
        '.claude/tmp/graphify-agent-eval/agent-eval-probe.json',
        '.claude/tmp/graphify-agent-eval/agent-eval-runs.jsonl',
        '.claude/tmp/graphify-agent-eval/v2/agent-eval-runs.jsonl',

...
export function composeGroupClaudeMd(group: AgentGroup): void {
  ...
  const agentsHeader = '<!-- Generated by composeGroupClaudeMd from CLAUDE.md. Do not edit. @-includes resolved inline for Codex. -->\n\n';
  writeAtomic(path.join(groupDir, 'AGENTS.md'), agentsHeader + agentsBody);

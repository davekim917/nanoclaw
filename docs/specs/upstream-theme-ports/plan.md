...
| 1       | **host-sweep** — _see the ordering note below_ |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
**Ordering note.** Host-sweep is numbered 1 for readability but **executes last**: it is the only theme with a hard seam-4 gate (claim-derived behavior needs A and A′ _deployed_; the runtime watch needs E). The execution order is agent-to-agent → cli-resources → scheduling → permissions → host-sweep. `taskNameSlug` and `task-content.ts` have **one owner: scheduling** (r2 had them in both places).
...
2. "the armed occurrence keeps its instant across a timezone change"; the _next_ re-arm uses the new grid.

...
for c in 'smoke-pr-gate.sh:5325' 'smoke-campaign-controller.py:1363-1365' \
         'smoke-run-scaffold.sh:267-269' 'smoke-campaign-controller.py:1352-1362'; do
...
cite smoke-campaign-controller.py 1308 'def _owner_wake'
cite smoke-campaign-controller.py 1358 'os.unlink("brief-{}.ack"'
cite smoke-campaign-controller.py 1363 'if c.get("wake"):'

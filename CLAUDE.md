...
This project is indexed by GitNexus as **nanoclaw** (1242 symbols, 3340 relationships, 98 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

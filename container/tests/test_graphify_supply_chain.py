...
class SupplyChainTest(unittest.TestCase):
    def test_lock_and_audit_are_bijective_and_hashed(self):
        ...
        self.assertEqual(audit["cutoff"], CUTOFF)
        ...
        self.assertEqual(locked["graphifyy"]["version"], "0.9.16")

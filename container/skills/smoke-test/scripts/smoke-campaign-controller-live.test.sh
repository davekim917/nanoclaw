...
for c in 'smoke-pr-gate.sh:5325' 'smoke-campaign-controller.py:1450-1452' \
         'smoke-run-scaffold.sh:267-269' 'smoke-campaign-controller.py:1439-1449'; do
...
cite smoke-campaign-controller.py 1395 'def _owner_wake'
cite smoke-campaign-controller.py 1445 'os.unlink("brief-{}.ack"'
cite smoke-campaign-controller.py 1450 'if c.get("wake"):'

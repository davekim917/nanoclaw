...
function registerBuiltInSweepDuties(): void {
  ...
  //
  // S15 (ceiling notice) and S10 (accountability wake) register from
  // src/modules/sweep-continuation/index.ts; S17's post-kill orphan-claim reset
  // registers from src/modules/sweep-session-core/index.ts (seam 2, PR 13/PR 9).
}

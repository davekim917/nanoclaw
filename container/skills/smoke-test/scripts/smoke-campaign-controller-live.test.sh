...
for c in 'smoke-pr-gate.sh:5325' 'smoke-campaign-controller.py:1381-1383' \
         'smoke-run-scaffold.sh:267-269' 'smoke-campaign-controller.py:1370-1380'; do
...
cite smoke-campaign-controller.py 1326 'def _owner_wake'
cite smoke-campaign-controller.py 1376 'os.unlink("brief-{}.ack"'
cite smoke-campaign-controller.py 1381 'if c.get("wake"):'

...
export const STEP_FILES: Record<string, string[]> = {
  ...
  'telegram-validate': ['.claude/skills/add-telegram/SKILL.md', 'setup/channels/run-channel-skill.ts'],
  'pair-telegram': [
  ...
  'slack-validate': ['.claude/skills/add-slack/SKILL.md', 'setup/channels/run-channel-skill.ts'],
  'imessage-install': [
    '.claude/skills/add-imessage/SKILL.md',
    'scripts/skill-apply.ts',
    'setup/channels/run-channel-skill.ts',
  ],
  imessage: ['.claude/skills/add-imessage/SKILL.md', 'setup/channels/run-channel-skill.ts'],

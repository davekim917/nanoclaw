...
# Byte-for-byte what the real `ncl --json` prints (ncl.ts:286).
cat <<'JSON'
{
  "id": "cli-1",
  "ok": true,
...
# Once the controller has marked the intent ambiguous (smoke-campaign-controller.py:938-941)
...
# (smoke-campaign-controller.py:1818 -> spawn :692-704, env=None) fell back to

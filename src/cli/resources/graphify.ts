...
registerResource({
  ...
  customOperations: {
    query: operation(
      ...
      ['ncl graphify query --query "customer retention" --group madison-reed'],
    ),
    path: operation(
      'open',
      ...
      ['ncl graphify path --from "conversation:123" --to "model:orders" --group madison-reed'],
    ),
    explain: operation(
      'open',
      ...
      ['ncl graphify explain --node "model:orders" --group madison-reed'],
    ),
    affected: operation(
      'open',
      ...
      ['ncl graphify affected --node "model:orders" --group madison-reed'],
    ),
    status: operation(
      'open',
    ...
    'ensure-fresh': operation(
      ...
      ['ncl graphify ensure-fresh --group madison-reed --timeout-ms 60000'],
    ),
    reindex: operation(
      'approval',
      ...
      ['ncl graphify reindex --group madison-reed --full'],
    ),
    pause: operation(
      'approval',
      ...
      ['ncl graphify pause --group madison-reed'],
    ),
    resume: operation(
      'approval',
      ...
      ['ncl graphify resume --group madison-reed'],
    ),
  },
});

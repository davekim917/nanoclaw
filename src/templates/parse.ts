 ...
 * is detected only to emit a migration error — there is no fallback parse.
 *
...
import type { ParsedMcpServerConfig } from '../container-config.js';
...
export interface Template {
  ...
  agentName?: string;
  mcpServers: Record<string, ParsedMcpServerConfig>; // mcp.json — name -> validated launch config

  ...
  tool: {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        model: {
          type: ['string', 'null'],
          description: 'Model to pin (e.g. `opus47`, `claude-sonnet-4-6`). Pass null to clear the per-channel override.',
        },
      },
      required: ['model'],
    },

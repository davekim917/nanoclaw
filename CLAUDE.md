...
This project is indexed by GitNexus as **nanoclaw** (1250 symbols, 3357 relationships, 99 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

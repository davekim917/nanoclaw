...
- Review lesson recorded for PR #788 in `docs/review-notes/788.md`: an identity
...
- The fragment passed the current main fragment-aware validator at b0987d39c:
  `scripts/review-notes.test.ts` (60 tests).
